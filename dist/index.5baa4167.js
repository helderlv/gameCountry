...
const getCountries = async ()=>{
    try {
        ...
        //console.log(data);
        console.log((0, _lodash.shuffle)(data[1].translations));
    } catch (error) {
...
},{"lodash":"3qBDj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./modules/Country":"awnIH","./modules/Game":"2CLui"}],"3qBDj":[function(require,module,exports) {
var global = arguments[3];
(function() {
...
},{}],"awnIH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Country {
    pays;
    ...
    #getTranslations(data) {
        for(let index = 0; index < data.length; index++)translations.push(mewSet.array(array.map(data[index].translation)));
    }
    #controlereponse(reponses) {
        if (translations.has(reponses)) return true;
        else return false;
    }
    #getdrapeau() {
        // div user
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2CLui":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Game {
    #score;
    index;
    instance;
    constructor(score, index, instance){
        this.score = score;
        this.index = index;
